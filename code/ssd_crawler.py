...
ssd_page_xpath = '/html/body/form/div/div[1]/div[1]/div[2]/ul[1]/li[6]/a'
driver.find_element_by_xpath(ssd_page_xpath).click()
...
def main():
    ...
    size_list = [x.split(" ")[-1][1:-1] for x in product_name_list]
    product_power_list = [x + '/ s)' for x in product_power_list]
